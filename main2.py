...
magnet_calibrate_list = [-47,74] #!地磁気補正データ
...
def go2(start, rmax =100, lmax=60 , t = 1.0):
...
def get_myangle() :
    ...
    myangle = (0 - math.degrees(math.atan2(x,y))) % 360
